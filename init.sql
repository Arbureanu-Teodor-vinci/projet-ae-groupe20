...
CREATE TABLE InternshipManagement.academic_years
(
    id_academic_year SERIAL PRIMARY KEY,
    academic_year    TEXT NOT NULL
);

CREATE TABLE InternshipManagement.students
(
    id_user       SERIAL REFERENCES InternshipManagement.users (id_user) PRIMARY KEY,
    academic_year INT NOT NULL REFERENCES InternshipManagement.academic_years (id_academic_year)
);

CREATE TABLE InternshipManagement.enterprises
(
...
(
    ...
    student          INT  NOT NULL REFERENCES InternshipManagement.students (id_user),
    enterprise       INT  NOT NULL REFERENCES InternshipManagement.enterprises (id_enterprise),
    academic_year    INT  NOT NULL REFERENCES InternshipManagement.academic_years (id_academic_year),
    version          INT  NOT NULL
);

CREATE TABLE InternshipManagement.internship_supervisors
(
...
CREATE TABLE InternshipManagement.internships
(
    id_internship         SERIAL PRIMARY KEY,
    subject               TEXT NOT NULL,
    signature_date        TEXT NOT NULL,
    internship_supervisor INT NOT NULL REFERENCES InternshipManagement.internship_supervisors (id_internship_supervisor),
    contact               INT NOT NULL REFERENCES InternshipManagement.contacts (id_contact),
    academic_year         INT NOT NULL REFERENCES InternshipManagement.academic_years (id_academic_year),
    version               INT NOT NULL
);
INSERT INTO InternshipManagement.academic_years
...
INSERT INTO InternshipManagement.students (id_user, academic_year)
VALUES ((SELECT id_user FROM InternshipManagement.users WHERE email = 'elle.skile@student.vinci.be'),
        (SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2021-2022')),
       ...
       ((SELECT id_user FROM InternshipManagement.users WHERE email = 'basile.demoulin@student.vinci.be'),
        (SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2022-2023')),
       ...
       ((SELECT id_user FROM InternshipManagement.users WHERE email = 'caroline.line@student.vinci.be'),
        (SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2023-2024')),
...
--ENTERPRISES-----------------------------------------------------------------------
INSERT INTO InternshipManagement.enterprises (trade_name, phone_number, address, city, version)
...
INSERT INTO InternshipManagement.internship_supervisors (last_name_supervisor, first_name_supervisor, phone_number,
                                                         email, enterprise)
VALUES ('Dossche', 'Stéphanie', '014.54.67.54', 'stephanie.dossche@letsbuild.com',
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'LetsBuild')),
       ('Alvarez Corchete', 'Roberto', '02.566.60.14', NULL,
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'Sopra Steria')),
       ('Assal', 'Farid', '0474 39 69 09', 'f.assal@assyst-europe.com',
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'Assyst Europe')),
       ('Ile', 'Emile', '0489 32 16 54', NULL,
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'La route du papier')),
       ('Hibo', 'Owln', '0456 678 567', NULL,
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'Infrabel')),
       ('Barn', 'Henri', '02 752 17 60', NULL,
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'AXIS SRL'));
...
VALUES ((SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2023-2024'),
        (SELECT id_user FROM InternshipManagement.users WHERE email = 'carole.skile@student.vinci.be'),
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'LetsBuild'),
       ...
       ((SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2023-2024'),
        (SELECT id_user FROM InternshipManagement.users WHERE email = 'ach.ile@student.vinci.be'),
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'Niboo'),
       ...
       ((SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2021-2022'),
        (SELECT id_user FROM InternshipManagement.users WHERE email = 'basile.frilot@student.vinci.be'),
        (SELECT id_enterprise FROM InternshipManagement.enterprises WHERE trade_name = 'The Bayard Partnership'),
...
INSERT INTO InternshipManagement.internships (subject, signature_date, internship_supervisor, contact, academic_year,
                                              version)
VALUES ('Un ERP:Odoo', '10-10-2023',
        (SELECT id_internship_supervisor
         FROM InternshipManagement.internship_supervisors
        ...
        (SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2023-2024'), 1),
       ...
       ('Conservation et restauration d’œuvres d’art', '2021-11-25',
        ...
        (SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2021-2022'), 1),
       ...
       ('Un métier : chef de projet', '2022-10-19',
        ...
        (SELECT id_academic_year FROM InternshipManagement.academic_years WHERE academic_year = '2022-2023'), 1),
       ('Un métier : chef de projet', '2022-10-19',
        (SELECT id_internship_supervisor
         FROM InternshipManagement.internship_supervisors
         WHERE last_name_supervisor = 'Barn'),
